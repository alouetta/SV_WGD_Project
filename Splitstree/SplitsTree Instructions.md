...
To infer a phylogenetic network from a vcf file of our population data we first create a Nei's matrix using the script wgd_arenosa_Nei_matrix.R. The script is a shortened version of the lab script adegenet_Ana_version.R provided by L.Yant.
...
- Add labels denoting diploid or tetraploid for each population in "Preview" using the excel file WGD_samples as a guide

**Script == wgd_arenosa_Nei_natrix.R**

**Packages used == R v4.4** **and** **SplitsTree v 4.19.2**
